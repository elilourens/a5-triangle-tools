...
final class Token {
	...
	public enum Kind {
		...
		ARRAY("array"), BEGIN("begin"), CONST("const"), DO("do"), ELSE("else"), END("end"),
		FUNC("func"), IF("if"), IN("in"), LET("let"), OF("of"), PROC("proc"), RECORD("record"),
		REPEAT("repeat"), THEN("then"), TYPE("type"), UNLESS("unless"),UNTIL("until"), VAR("var"), WHILE("while"),
